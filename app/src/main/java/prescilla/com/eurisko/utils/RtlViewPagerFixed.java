...
/**
 * Created by koa on 2/28/2017.
 */

/**
 * ViewPager that reverses the items order in RTL locales.
 */
public class RtlViewPagerFixed extends ViewPager {
    ...
    public RtlViewPagerFixed(Context context) {
        super(context);
        reverseOnPageChangeListeners = new ArrayMap<>(1);
    }

    public RtlViewPagerFixed(Context context, AttributeSet attrs) {
        super(context, attrs);
        reverseOnPageChangeListeners = new ArrayMap<>(1);
    }
